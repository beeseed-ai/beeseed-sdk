...
export type WSEvent =
  ...
  | ({ type: 'local_agent.run.succeeded' | 'local_agent.run.failed' | 'local_agent.run.cancelled'; channel_id: string; agent_id?: string; device_id?: string; run_id: string; capability?: string; status?: string; output?: unknown; error?: unknown } & AgentLoopWireFields)
  // UI events
